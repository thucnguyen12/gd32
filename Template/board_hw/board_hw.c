...
void board_hw_initialize(void)
{
    ...
    //spi gpio
    gpio_mode_set(GPIO_SPI0_SCK_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_SPI0_SCK_PIN);
    gpio_output_options_set(GPIO_SPI0_SCK_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_SPI0_SCK_PIN);
    
    gpio_mode_set(GPIO_SPI0_MISO_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_SPI0_MISO_PIN);
    gpio_output_options_set(GPIO_SPI0_MISO_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_SPI0_MISO_PIN);
    
    gpio_mode_set(GPIO_SPI0_MOSI_PORT, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_SPI0_MOSI_PIN);
