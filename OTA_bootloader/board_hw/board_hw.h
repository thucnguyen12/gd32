...
#define GPIO_LCD_RST_PIN GPIO_PIN_2
#define GPIO_LCD_PWM_PORT GPIOB
#define GPIO_LCD_PWM_PIN GPIO_PIN_2
//spi
...
#define GPIO_LORA_IO4_PIN GPIO_PIN_5
#define GPIO_LORA_EN_PORT GPIOB
#define GPIO_LORA_EN_PIN GPIO_PIN_5
//nrf
#define GPIO_NRF_CS_PORT GPIOB
#define GPIO_NRF_CS_PIN GPIO_PIN_5
#define GPIO_ZIGBEE_CS_PORT GPIOB
#define GPIO_ZIGBEE_CS_PIN GPIO_PIN_2
//esp reset pin
